 ...
 */
 ...
 #include <string.h> //kutuphaneleri tanimladim
	...
	if ( strcmp(tahmin, e) == 0 ) //kullanicinin tahmini dogru ise ekrana bildin yazisini bastirir
		printf("TEBRIKLER KAZANDINIZ");
	else if ( strcmp(tahmin, b)==0 ) // string kullanimi kıyaslamada strcmp(strg1,strg2)==0
		printf("TEBRIKLER KAZANDINIZ");
	else if ( strcmp(tahmin, s) == 0 ) // tanimlanmis dizinlerle kullanicinin girdigi kelime ayi ise ekrana TEBRİKLER KAZANDİNİZ bastirir.
		printf("TEBRIKLER KAZANDINIZ");	
	else if ( strcmp(tahmin, ko) == 0 )
		printf("TEBRIKLER KAZANDINIZ");
	else if ( strcmp(tahmin, k) == 0 )
		printf("TEBRIKLER KAZANDINIZ");
	else
		printf("KAYBETTINIZ");
